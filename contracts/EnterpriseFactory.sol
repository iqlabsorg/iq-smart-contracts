...
contract EnterpriseFactory {
    ...
    function deploy(
        ...
        ILoanCostEstimator loanCostEstimator = ILoanCostEstimator(estimator.clone());
        ...
        loanCostEstimator.initialize(enterprise);
    ...
    function deployInterestToken(string memory symbol, IEnterprise enterprise) internal returns (IInterestToken) {
