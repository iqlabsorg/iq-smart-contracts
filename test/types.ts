export enum Errors {
  ...
  E_CALLER_NOT_BORROW_TOKEN = '39',
  E_INVALID_BASE_TOKEN_ADDRESS = '40',
  E_SERVICE_LIMIT_REACHED = '41',
  E_INVALID_LOAN_DURATION_RANGE = '42',
  E_SERVICE_GAP_HALVING_PERIOD_NOT_GT_0 = '43',
  E_UNSUPPORTED_INTEREST_PAYMENT_TOKEN = '44',
  E_LOAN_DURATION_OUT_OF_RANGE = '45',
  E_INSUFFICIENT_LIQUIDITY = '46',
  E_LOAN_COST_SLIPPAGE = '47',
  E_INVALID_LOAN_TOKEN_ID = '48',
  E_INVALID_LOAN_DURATION = '49',
  E_FLASH_LIQUIDITY_REMOVAL = '50',
  E_WRAPPING_NOT_ALLOWED = '51',
  E_LOAN_TRANSFER_NOT_ALLOWED = '52',
  E_INVALID_CALLER_WITHIN_BORROWER_GRACE_PERIOD = '53',
  E_INVALID_CALLER_WITHIN_ENTERPRISE_GRACE_PERIOD = '54',

  EF_INVALID_ENTERPRISE_IMPLEMENTATION_ADDRESS = '55',
  EF_INVALID_POWER_TOKEN_IMPLEMENTATION_ADDRESS = '56',
  EF_INVALID_INTEREST_TOKEN_IMPLEMENTATION_ADDRESS = '57',
  EF_INVALID_BORROW_TOKEN_IMPLEMENTATION_ADDRESS = '58',

  EO_INVALID_ENTERPRISE_ADDRESS = '59',

  ES_INVALID_ESTIMATOR_ADDRESS = '60',
  ES_INVALID_COLLECTOR_ADDRESS = '61',
  ES_INVALID_VAULT_ADDRESS = '62',
  ES_INVALID_CONVERTER_ADDRESS = '63',
  ES_INVALID_BORROWER_LOAN_RETURN_GRACE_PERIOD = '64',
  ES_INVALID_ENTERPRISE_LOAN_COLLECT_GRACE_PERIOD = '65',
  ES_INTEREST_GAP_HALVING_PERIOD_NOT_GT_0 = '66',
  ES_MAX_SERVICE_FEE_PERCENT_EXCEEDED = '67',
  ES_INVALID_BASE_TOKEN_ADDRESS = '68',
  ES_INVALID_LOAN_DURATION_RANGE = '69',
  ES_PERPETUAL_TOKENS_ALREADY_ALLOWED = '70',
