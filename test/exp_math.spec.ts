...
describe("ExpMath", function() {
  ...
  // t0     c0      t12   t    exp   delta
    ...
    [0n,   4503599627370449.333, 75n ** 5n, 75n ** 5n - 1n, 4503599627370449.333 * Math.pow(0.5, (75 ** 5 - 1) / 75 ** 5)],
    [0n,   Number.MAX_SAFE_INTEGER / 2.0, 75n ** 5n, 75n ** 5n - 1n, (Number.MAX_SAFE_INTEGER / 2.0) * Math.pow(0.5, (75 ** 5 - 1) / 75 ** 5)],
  ] as TestCase[]) 
